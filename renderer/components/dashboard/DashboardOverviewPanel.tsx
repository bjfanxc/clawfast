...
import { AlertTriangle, Clock3, Database, Layers3, RadioTower, RefreshCw } from 'lucide-react'
    ...
    <Card className="min-w-0 rounded-[28px] border-border/80 bg-card/95 shadow-sm">
      <CardContent className="p-6">
        <div className="flex min-w-0 items-center gap-4">
          <div className="shrink-0 rounded-2xl border border-primary/16 bg-primary/10 p-3 text-primary dark:border-primary/35 dark:bg-primary/20 dark:text-primary">
            {icon}
          </div>
